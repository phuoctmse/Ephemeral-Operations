...
import { CreateSandboxEnvDto, SandboxEnvResponseDto } from './dto/sandbox-env.dto';
...
export class SandboxEnvController {
  ...
  @ApiResponse({ status: 201, description: 'Environment created', type: SandboxEnvResponseDto })
  @ApiResponse({ status: 400, description: 'Invalid input or guardrails violation' })
  @ApiResponse({ status: 403, description: 'Instance type not allowed or concurrency limit reached' })
  ...
  @ApiResponse({ status: 200, description: 'List of environments', type: [SandboxEnvResponseDto] })
  async findAll() {
  ...
  @ApiResponse({ status: 200, description: 'Environment details', type: SandboxEnvResponseDto })
  ...
  @ApiResponse({ status: 200, description: 'Environment terminated', type: SandboxEnvResponseDto })
  @ApiResponse({ status: 404, description: 'Environment not found' })
